...
### Local Dev and Content Conversion
...
This _AI first_ experiment was completed much quicker and with less hair pulling, than if I had tried to pour through documentation and online help. For me, using AI as an intelligent partner is a great way to learn new tools and techniques to get things done quickly. It lessens the pain points, while still keeping the tasks interesting enough (at least for me).

> Reach out to me via the social or email links below if you have questions or want me to dive deeper in a future article.
